package com.cosmo.sporenmore.client.models.entity.model;
...
public class ModModelLayers {
    ...
    public static final ModelLayerLocation THE_DEVOURER_LAYER = new ModelLayerLocation(
            new ResourceLocation(SporeNMore.MOD_ID, "the_devourer_layer"), "main");
