...
/*
Created by Cosmo on 10/19/2023
*/

public class EntityBuldgingSporeFox extends Monster implements GeoEntity {
    ...
    private PlayState predicate(AnimationState<EntityBuldgingSporeFox> entityBuldgingSporeFoxAnimationState) {

        if (entityBuldgingSporeFoxAnimationState.isMoving()) {
            entityBuldgingSporeFoxAnimationState.getController().setAnimation(RawAnimation.begin().then("animation.entity_buldging_spore_fox.walk", Animation.LoopType.LOOP));
            return PlayState.CONTINUE;
        } else {
            entityBuldgingSporeFoxAnimationState.getController().setAnimation(RawAnimation.begin().then("animation.entity_buldging_spore_fox.idle", Animation.LoopType.LOOP));
        }
        return PlayState.CONTINUE;
